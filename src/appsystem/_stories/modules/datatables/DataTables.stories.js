...
import DemoTable from '../../../modules/datatables/DemoTable'


export default {
	title: "Modules|DataTables/DemoTable",
	parameters: {
		component: DemoTable,
	},
...
export const asDemoTable = () => (
  <DemoTable title="Demo Data Table" perPage={10} currentPage={1} data={
    [
      {
        id: 1,
        name: "Slade1",
